...
Route::post('/nhapmember/submit', 'App\Http\Controllers\myController@nhapmember');

// Route::get('/nhapproduct', 'App\Http\Controllers\myController@nhapproduct');
Route::get('/nhapproduct', function(){
    return view('nhapproduct');
});
Route::post('/nhapproduct/submit', 'App\Http\Controllers\myController@nhapproduct');

Route::get('nhapinvoice', function(){
    return view('nhapinvoices');
});
Route::post('/nhapinvoice/submit', 'App\Http\Controllers\myController@nhapinvoices');
